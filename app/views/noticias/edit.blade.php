...
<div id="page-content">
    <h3><strong>Editar noticia</strong></h3>
    <br/>
    <br/>
    <div class="col-md-8">
        {{ Form::model($noticia, array('method' => 'PATCH', 'route' => array('admin.noticias.update', $noticia->id))) }}
        <div class="form-row">
        ...
        <div class="form-row">
            ...
            <div class="form-input col-md-8">
                <input type="text" data-required="true" data-trigger="change" data-type="text" name="titulo" value="{{ $noticia->titulo}}" id="nombreF">
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-input col-md-8">
                <input type="text" data-required="true" data-trigger="change" data-type="text" name="bajada"  value="{{ $noticia->bajada}}" id="nombreF">
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-input col-md-8">
                {{ Form::input('text','img_principal','',['id'=>'img_principal','onclick'=>'openKCFinder(this)']) }}
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-input col-md-8">
                <input type="text" data-required="true" data-trigger="change" data-type="text" name="epigrafe"  value="{{ $noticia->epigrafe}}" id="epigrafe">
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-input col-md-10">
                <textarea name="desarrollo" id="descripcion" rows="3">{{ $noticia->desarrollo}} </textarea>
            </div>
        </div>
            ...
            <div id="resBusImagenes"  tabindex="-1">
                <table id="listaImagenes" class="table table-rounded" class="display" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><input type="text" disabled="disabled" class="form-control input-mini" id="imagen_cargadas[{{$row->id }}]" name="imagen_cargadas[{{$row->id }}]" value="{{ $row->nombre }}" onclick="openKCFinder(this);" /></td>
                            <td><a onclick ="eliminarFila_imagenes(this, 'listaImagenes','{{$row->id}}' );" class ="btn btn-danger"> Eliminar</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
...
<script type='text/javascript'>
            ...
            function eliminarFila_imagenes(link, tabla, id) {
            $.ajax({
            type: 'POST',
                    url: 'eliminacionFisicaImagenRelacionada',
                    dataType: "json",
                    data: {
                    id: id
                    },
            ...
            function eliminarFila_imagenes(link, tabla, id) {
                $.ajax({
                    type: 'POST',
                    url: 'eliminacionVideoRelacionado',
                    dataType: "json",
                    data: {
                        id: id
                    },
            ...
            var aleatorio = Math.floor(Math.random() * 51) + 25;
                    var html = '<tr>\n\
                                    <td><input type="text" class="form-control input-mini" id="imagen_relacionadas[' + aleatorio + ']" name="imagen_relacionadas[' + aleatorio + ']" value="" onclick="openKCFinder(this);" /></td>\n\
                                    <td><a onclick ="eliminarFila(this,\'listaColores\');" class ="btn btn-danger"> Eliminar</a></td>\n\
                                 </tr>';
                    $('#listaImagenes').find('tbody').append(html);
            }
