...
<div id="page-content">
    <h3><strong>Editar delegación</strong></h3>
    <br/>
    <br/>
    <div class="col-md-8">
        {{ Form::model($delegacion, array('method' => 'PATCH', 'route' => array('admin.delegaciones.update', $delegacion->id))) }}
        ...
        <div class="form-row">
            ...
            <div class="form-input col-md-10">
                <textarea name="desarrollo" id="desarrollo" rows="3">{{ $delegacion->desarrollo}}</textarea>
            </div>
        </div>
