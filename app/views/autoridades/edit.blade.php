...
<div id="page-content">
    <h3><strong>Editar Autoridad</strong></h3>
    <br/>
    <br/>
    <div class="col-md-8">
        {{ Form::model($autoridad, array('method' => 'PATCH', 'route' => array('admin.autoridades.update', $autoridad->id))) }}
        ...
        <div class="form-row">
            ...
            <div class="form-input col-md-4">
                {{ Form::select('estado_id',$estados,'',['data-required'=>'true','data-trigger'=>'change','data-type'=>'text','id'=>'estado_id']) }}
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-input col-md-8">
                {{ Form::input('text', 'imagen',null,['id'=>'img_principal','onclick'=>'openKCFinder(this)']) }}
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-input col-md-10">
                <textarea name="descripcion" id="descripcion" rows="3">{{ $autoridad->descripcion }}</textarea>
            </div>
        </div>
