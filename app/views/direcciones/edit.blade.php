...
<div id="page-content">
    <h3><strong>Editar Direccion</strong></h3>
    <br/>
    <br/>
    <div class="col-md-8">
        {{ Form::model($direccion, array('method' => 'PATCH', 'route' => array('admin.direcciones.update', $direccion->id))) }}
        ...
        <div class="form-row">
            ...
            <div class="form-input col-md-10">
                <textarea name="desarrollo" id="descripcion" rows="3">{{ $direccion->desarrollo }}</textarea>
            </div>
        </div>
