...
<div id="page-content">
    <h3><strong>Alerta -> Editar</strong></h3>
    <br/>
    <br/>
    <div class="col-md-8">
        {{ Form::model($alerta, array('method' => 'PATCH', 'route' => array('admin.alertas.update', $alerta->id))) }}
        ...
        <div class="form-row">
            ...
            <div class="form-input col-md-8">
                <input type="text" data-required="true" data-trigger="change" data-type="text" name="descripcion" value="{{ $alerta->descripcion }}"id="nombreF">
            </div>
        </div>
