...
<div id="page-content">
    ...
    <br/>
    <div class="col-md-8">
         {{ Form::model($categoria, array('method' => 'PATCH', 'route' => array('admin.categorias.update', $categoria->id))) }}
        <div class="form-row">
            ...
            <div class="form-input col-md-8">
                <input type="text" data-required="true" data-trigger="change" data-type="text" name="descripcion" value="{{ $categoria->descripcion }}"id="nombreF">
            </div>
        </div>
